        ...
        <div className="bg-gradient-to-br from-white via-cream-100 to-cream-50 rounded-3xl p-8 sm:p-12 border border-cream-300 shadow-md grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-sm text-charcoal-800/80 leading-relaxed">
                Tailored with your chosen pressure — from firm therapeutic hands-on myofascial kneading to the deep thermal penetration of heated volcanic basalt stones or smooth warm bamboo canes.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              <div className="p-3.5 rounded-2xl bg-white border border-cream-200 shadow-sm">
                <h4 className="text-xs font-bold text-sage-900 uppercase tracking-wider">Warm Bamboo Canes</h4>
                <p className="text-xs text-charcoal-800/70 mt-1 leading-relaxed">
                  Smooth heated canes deliver firm, elongated kneading to unknot stubborn muscle bands and aid lymphatic drainage.
                </p>
              </div>
              <div className="p-3.5 rounded-2xl bg-white border border-cream-200 shadow-sm">
                <h4 className="text-xs font-bold text-sage-900 uppercase tracking-wider">Volcanic Hot Stones</h4>
                <p className="text-xs text-charcoal-800/70 mt-1 leading-relaxed">
                  Warm basalt stones radiate deep soothing heat directly into contracted muscle tissue, melting away stiffness.
                </p>
              </div>
            </div>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <button
                onClick={() => openFresha('https://www.fresha.com/book-now/the-beauty-barn-sowuxl7s/services?lid=380113&share=true&pId=354459', 'The Deep Tissue Massage')}
                className="px-6 py-3 rounded-xl bg-sage-800 hover:bg-sage-900 text-cream-50 text-xs font-semibold uppercase tracking-wider transition shadow-md flex items-center gap-2"
              >
                <Calendar className="w-3.5 h-3.5 text-bronze-300" />
              ...
              <span className="text-xs text-charcoal-800/70">
                +£5 for Warm Bamboo or Hot Stones upgrade
              </span>
            </div>
          </div>
