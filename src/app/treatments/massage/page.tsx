    ...
    <div className="space-y-20 pb-24">
      ...
      <section className="bg-gradient-to-b from-cream-200 to-cream-50 py-16 px-4 sm:px-6 lg:px-8 border-b border-cream-200">
        ...
        <div className="max-w-6xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="relative h-64 rounded-3xl overflow-hidden shadow-md border border-cream-300 group bg-charcoal-950">
            <video
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent pointer-events-none" />
            <div className="absolute bottom-4 left-4 right-4 text-white pointer-events-none">
              <span className="text-[10px] uppercase font-bold tracking-widest text-bronze-300 block">Therapeutic Heat</span>
              <p className="font-serif text-base font-medium">Hot Stone Massage</p>
            </div>
          </div>
        </div>
      </section>
